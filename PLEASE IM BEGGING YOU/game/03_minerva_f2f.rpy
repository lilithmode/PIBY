label angry_minerva_convo:
    ...
    b "..."
    show angry bashful at hop
    b "..."

    t "i think we need to move on."
    show angry head at hop
    ...
    show angry bashful at hop
    am "OKAY. FINE."
    hide angry bashful with dissolve
    play music "audio/_music/pious v2.mp3" volume 0.5
